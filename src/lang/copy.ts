...
interface SiteCopyType {
    home: CopyType;
    scripts: CopyType;
    contact: CopyType;
    test: any;
}
export const copy: SiteCopyType = {
    home: {
        title: 'About Dan',
        copy: '',
        cta: '',
    ...
    scripts: {
        title: 'Scripts',
        copy: `Dan has written loads of scripts, and is dead good at it. I'm waiting for him to give me some proper words on this, so just trust me and that. Dead good...promise.
        
        If you want to check out a snippet of his genius, click on any of the scripts below for a sample. Then be all "ooooh, I want to read more" and get in touch with the man himself.`,
        cta: `Above is a mere excerpt from a full script. Feel free to get in touch with Dan and he can hook you up with more words and information.`
    },
    contact: {
        title: 'Contact Dan',
        copy: `Want to get in touch with Dan? Can hardly blame you, he's a pretty cool guy. Anyway, you can do that from here.
        
        Pop your message below and it'll find it's way to Dan's inbox, and he'll get back to you when he summmons the exectuive function.`,
        cta: '',
    },
    test: {
